...
heading3('5.4.1 接口响应时间测试')

para('针对系统的六个核心接口进行响应时间测试，覆盖推荐、广告、商品、活跃度和社区五个功能模块。测试结果如表5.2所示，所有接口的平均响应时间均在设计目标范围内。')
