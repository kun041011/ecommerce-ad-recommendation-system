...
figure_placeholder('图4-2 系统首页界面截图')

figure_placeholder('图4-3 商品详情页界面截图')

figure_placeholder('图4-4 管理后台数据分析界面截图')
...
figure_placeholder('图5-1 单元测试执行结果截图')

figure_placeholder('图5-2 集成测试执行结果截图')
